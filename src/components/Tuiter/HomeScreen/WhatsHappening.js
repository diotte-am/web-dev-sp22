...
const WhatsHappening = () => {
    const [newTuit, setNewTuit] =
        useState({logoImage: 'https://cdn.pixabay.com/photo/2013/07/12/16/51/internet-151384_960_720.png', tuit: 'New tuit', liked: false, disliked: false, likes: 0, dislikes: 0, postedBy: {username: 'AmareDiotte'}});
